...
export let debug = (...args) => {if (debugEnabled > 1) console.log(`DEBUG:${VARIANT_ENCUMBRANCE_MODULE_NAME} | `, ...args)};
export let log = (...args) => console.log(`${VARIANT_ENCUMBRANCE_MODULE_NAME} | `, ...args);
export let warn = (...args) => {if (debugEnabled > 0) console.warn(`${VARIANT_ENCUMBRANCE_MODULE_NAME} | `, ...args)};
