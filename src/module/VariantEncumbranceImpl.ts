...
export const VariantEncumbranceImpl = {
  ...
  updateEncumbrance: async function (
    ...
    const encumbranceData = VariantEncumbranceImpl.calculateEncumbrance(actorEntity, veitem); //, itemSet, effectSet
   ...
   * @private
   */
  calculateEncumbrance: function (actorEntity: Actor, veitem: VariantEncumbranceItemData | null): EncumbranceData {
    //, itemSet, effectSet
